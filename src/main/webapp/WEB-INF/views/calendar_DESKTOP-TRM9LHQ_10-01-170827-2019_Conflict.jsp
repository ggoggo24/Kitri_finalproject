...
<link href="<c:url value="/resources/css/sb-admin.css"/>" rel="stylesheet">
  ...
  <link rel="stylesheet" href="<c:url value="/resources/vendor/css/fullcalendar.min.css" />">
  <link rel="stylesheet" href="<c:url value="/resources/vendor/css/bootstrap.min.css"/>">
  <link rel="stylesheet" href="<c:url value="/resources/vendor/css/select2.min.css" />">
  <link rel="stylesheet" href="<c:url value="/resources/vendor/css/bootstrap-datetimepicker.min.css" />">
  

  <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Open+Sans:400,500,600">
  <link rel="stylesheet" href="https://fonts.googleapis.com/icon?family=Material+Icons">

  <link rel="stylesheet" href="<c:url value="/resources/calendar/css/main.css"/>">
